...
export default function Properties() {
  ...
  const updateQuery = (
    ...
    router.push(`/admin/properties?${query.toString()}`, { scroll: false });
  };
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {properties.map((property: any) => (
                <Link key={property._id} href={`/admin/properties/${property._id}`}>
                  <Card className="overflow-hidden hover:shadow-lg transition-shadow group">
                    ...
                    >
                      ...
                      <Badge className="absolute bottom-3 text-[12px] left-3 bg-primary text-primary-foreground">
                        {property.state}
                      </Badge>
                      <Badge className="absolute bottom-3 text-[12px] right-3 bg-primary text-primary-foreground">
                    ...
                    <CardContent className="">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center text-muted-foreground">
                          <p className="mr-[5px] text-[12px] text-muted-foreground/70">
                             By:
                          </p>
